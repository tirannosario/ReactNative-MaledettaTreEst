...
class BoardPage extends React.Component {
    ...
    componentDidMount(){
        ...
        // prendo gli sponsors
        CommunicationController.getSponsors(sid)
        .then(unmarshelledObject => {
            this.state.sponsorList = unmarshelledObject.sponsors
            console.log("esamefebbraio numero sponsors: " + this.state.sponsorList.length)
            for(const sponsor of this.state.sponsorList) {
                console.log("esamefebbraio nome: " + sponsor.name + ", lat: " + sponsor.lat + ", lon: " + sponsor.lon)
            }
        })
        .catch(error => {
            console.log(error)
    ...
    handleDetailClick = () => {
        this.props.navigation.navigate("Map", {did: this.state.did, stations: this.state.stations, sponsors: this.state.sponsorList})
    }
